...
const ACTION_LABEL_KEY: Record<string, string> = {
  ...
  update: "actionUpdate",
  delete: "actionDelete",
  approve: "actionApproveLog",
  reject: "actionRejectLog",
  role_change: "actionRoleChange",
};

const TARGET_TYPE_LABEL_KEY: Record<string, string> = {
  skill: "targetSkill",
  agent: "targetAgent",
...
export default function AdminLogsPage() {
  ...
  const actionLabel = (action: string) => {
    ...
    return key ? t(key) : action.replace("_", " ");
  };
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="bg-gray-50 border-b border-gray-200">
                <th className="text-start px-4 py-3 font-medium text-gray-600">{t("colTimestamp")}</th>
                <th className="text-start px-4 py-3 font-medium text-gray-600">{t("colAdmin")}</th>
                <th className="text-start px-4 py-3 font-medium text-gray-600">{t("colAction")}</th>
                <th className="text-start px-4 py-3 font-medium text-gray-600">{t("colTargetType")}</th>
                <th className="text-start px-4 py-3 font-medium text-gray-600">{t("colTargetId")}</th>
                <th className="text-start px-4 py-3 font-medium text-gray-600">{t("colDetail")}</th>
              </tr>
            </thead>
            <tbody>
              {loading ? (
