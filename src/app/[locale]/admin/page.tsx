...
export default function AdminDashboard() {
  ...
  const cards = [
    { label: t("statTotalSkills"), value: formatNum(stats.totalSkills), icon: Package, color: "bg-purple-500" },
    { label: t("statTotalUsers"), value: formatNum(stats.totalUsers), icon: Users, color: "bg-blue-500" },
    { label: t("statCategories"), value: stats.totalCategories.toString(), icon: FolderTree, color: "bg-green-500" },
    ...
    { label: t("statPendingReview"), value: stats.pendingSkills.toString(), icon: Clock, color: stats.pendingSkills > 0 ? "bg-orange-500" : "bg-gray-400" },
  ];
            ...
            {stats.recentSkills.map((skill) => (
              <div key={skill.id} className="flex items-center justify-between text-sm">
                <div>
                  ...
                  <span className="text-gray-400 ms-2">{t("byAuthor", { author: skill.author })}</span>
                </div>
