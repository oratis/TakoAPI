    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="flex flex-wrap items-center gap-3 mb-6">
        ...
        <select
          ...
          className="text-sm border border-gray-300 rounded-lg px-3 py-1.5 bg-white"
        >
          <option value="">{t("agentAll")}</option>
          <option value="CLAUDE_CODE">{t("agentClaudeCode")}</option>
          <option value="CURSOR">{t("agentCursor")}</option>
          <option value="WINDSURF">{t("agentWindsurf")}</option>
          <option value="CODEX">{t("agentCodex")}</option>
          <option value="AIDER">{t("agentAider")}</option>
          <option value="CLINE">{t("agentCline")}</option>
          <option value="COPILOT">{t("agentCopilot")}</option>
          <option value="GENERIC">{t("agentGeneric")}</option>
        </select>
